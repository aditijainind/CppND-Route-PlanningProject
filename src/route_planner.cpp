...
void RoutePlanner::AddNeighbors(RouteModel::Node *current_node) {
    ...
    for(RouteModel::Node *neighborItem : current_node->neighbors){
        neighborItem->parent = current_node;
        neighborItem->h_value = CalculateHValue(neighborItem);
        neighborItem->g_value = start_node->distance(*neighborItem); 
        neighborItem->visited = true;
        open_list.push_back(neighborItem);
    }
}
...
void SortList(std::vector<RouteModel::Node*>* v){
...
std::vector<RouteModel::Node> RoutePlanner::ConstructFinalPath(RouteModel::Node *current_node) {
    ...
    while(iter_node->parent!=nullptr){
        ...
        distance+=iter_node->distance(*iter_node->parent);
